...
export class SingleProductComponent {
  ...
  ngOnInit() {
    ...
    this.inCart=this.user.cart.some((el:any)=>{return el==this.data._id})
  }
  WishList(){
    ...
    // this.http.patch<any>(`http://localhost:3000/user/wishlist/${this.user._id}`, {productId:this.data._id}).subscribe(
    //   (response) => {
